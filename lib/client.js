...
function matchesFilter(model, filter) {
  ...
  return model.name !== void 0 && model.name.toLowerCase().includes(needle);
}
...
function groupOfficialCredRef(id) {
  const safe = id.replace(/[^A-Za-z0-9_]/g, "_");
...
function NewApiSection(props) {
  ...
  const [filters, setFilters] = (0, import_react.useState)(/* @__PURE__ */ new Map());
  ...
  const load = async () => {
    ...
    try {
      ...
      const refs = [...new Set(drafts.flatMap((group) => {
        ...
        return modeOf(group) === "official-direct" ? [groupCredRef(gid), groupOfficialCredRef(gid)] : [groupCredRef(gid)];
      }))];
    ...
    try {
      ...
      const serializedGroups = groups.map((group) => {
        ...
        return {
          id,
          ...name.length > 0 ? { name } : {},
          ...mode === "official-direct" ? { mode: "official-direct" } : {},
          ...mode === "official-direct" && officialBaseURL.length > 0 ? { officialBaseURL } : {},
          ...baseURL.length > 0 && mode === "newapi" ? { baseURL } : {},
          ...apiTypeOf(group) === "responses" && mode === "newapi" ? { apiType: "responses" } : {},
          models,
          ...mode === "newapi" && proxy !== void 0 ? {
            proxy: {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": t("nav"), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-groups", children: [
      ...
      groups.map((group, index) => {
        ...
        const officialCred = mode === "official-direct" ? credentials[officialRef] : void 0;
        ...
        const groupParams = mode === "official-direct" ? void 0 : params.get(gid);
        const groupCandidates = mode === "official-direct" ? void 0 : candidates.get(gid);
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-group", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-group-head", children: [
            ...
            mode === "official-direct" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-badge", title: t("modeOfficialHint"), children: t("officialBadge") }) : null,
            mode === "newapi" && apiTypeOf(group) === "responses" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-badge", title: t("apiTypeResponsesHint"), children: t("apiTypeResponses") }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "span",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-count", children: mode === "official-direct" ? t("officialBadge") : `${String(groupModels.length)} ${t("models")}` }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                type: "button",
          ...
          expanded ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-group-body", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-field", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: `newapi-mode-${index}`, children: t("mode") }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "select",
                {
                  id: `newapi-mode-${index}`,
                  className: "newapi-select",
                  "aria-label": `${t("mode")} ${String(index + 1)}`,
                  value: modeOf(group),
                  onChange: (event) => {
                    patchGroup(index, { mode: event.target.value });
                  },
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "newapi", children: t("modeNewapi") }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "official-direct", children: t("modeOfficial") })
                  ]
                }
              ),
              modeOf(group) === "official-direct" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-hint", children: t("modeOfficialHint") }) : null
            ] }),
            modeOf(group) === "official-direct" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-field", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: `newapi-okey-${index}`, children: t("officialKeyInput") }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "input",
                  {
                    id: `newapi-okey-${index}`,
                    type: "password",
                    autoComplete: "off",
                    className: "newapi-input",
                    disabled: officialCred?.locked === true,
                    "aria-label": `${t("officialKeyInput")} ${String(index + 1)}`,
                    placeholder: officialCred?.locked === true ? t("keyEnvLocked") : officialCred?.configured === true ? t("keyStored") : t("keyMissing"),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-field", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: `newapi-obase-${index}`, children: t("officialBaseUrl") }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "input",
                  {
                    id: `newapi-obase-${index}`,
                    type: "text",
                    className: "newapi-input",
                    placeholder: t("officialBaseUrlPlaceholder"),
                    value: textOf(group, "officialBaseURL"),
                    "aria-label": `${t("officialBaseUrl")} ${String(index + 1)}`,
                    onChange: (event) => {
                      patchGroup(index, { officialBaseURL: event.target.value });
                    }
                  }
                )
              ] })
              ...
              modeOf(group) === "newapi" && groupCandidates !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-candidates", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-candidates-head", children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "newapi-linkbutton", disabled: visible.length === 0, onClick: () => {
                    toggleAll(gid);
                  }, children: allVisibleSelected ? t("fetchUnselectAll") : t("fetchSelectAll") })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "input",
                  {
                    className: "newapi-input newapi-candidates-search",
                    type: "text",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: visible.map((model) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "input",
                    {
                      type: "checkbox",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "newapi-button newapi-button--primary", disabled: selected.size === 0, onClick: () => {
                  adopt(gid);
              ...
              modeOf(group) === "newapi" && groupParams !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-params", ref: paramsRef, children: [
...
var zh = {
  ...
  mode: "\u8FDE\u63A5\u6A21\u5F0F",
  modeNewapi: "NewAPI \u7F51\u5173\uFF08\u9ED8\u8BA4\uFF09",
  modeOfficial: "\u5B98\u65B9\u76F4\u901A\uFF08DeepSeek \u5B98\u65B9 API\uFF09",
  modeOfficialHint: "\u7ED5\u8FC7 NewAPI \u7F51\u5173\u76F4\u8FDE DeepSeek \u5B98\u65B9\u7AEF\u70B9\uFF1A\u5B8C\u6574\u652F\u6301\u63A8\u7406\u5757\u3001reasoning_effort \u4E0E\u5DE5\u5177\u8C03\u7528\uFF1B\u6A21\u578B\u76EE\u5F55\u4E0E\u4E0A\u4E0B\u6587\u7A97\u53E3\u6765\u81EA\u5B98\u65B9\u9002\u914D\u5668\u5185\u7F6E\u76EE\u5F55\u3002",
  officialBaseUrl: "DeepSeek \u5B98\u65B9 API \u5730\u5740",
  officialBaseUrlPlaceholder: "https://api.deepseek.com",
  officialKeyInput: "DeepSeek \u5B98\u65B9 API \u5BC6\u94A5",
  officialBadge: "\u5B98\u65B9\u76F4\u901A",
  keyInput: "API \u5BC6\u94A5",
...
var en = {
  ...
  modeNewapi: "NewAPI gateway (default)",
  modeOfficial: "Official direct (DeepSeek official API)",
  modeOfficialHint: "Bypasses the NewAPI gateway straight to the DeepSeek official endpoint: full reasoning-block, reasoning_effort, and tool-call support; the model catalog and context windows come from the official adapter's built-in catalog.",
  officialBaseUrl: "DeepSeek official API base URL",
  officialBaseUrlPlaceholder: "https://api.deepseek.com",
  officialKeyInput: "DeepSeek official API key",
  officialBadge: "Official direct",
  keyInput: "API key",
